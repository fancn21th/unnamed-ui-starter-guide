...
import {useAppState} from "@/contexts/app-context.tsx";
...
type MessageContent =
    ...
    tasklist?: { dataSource: TodoItem[]; title?: string; status?: "pending" | "confirmed"; editable?: boolean }
}
...
export function MessageList() {
    ...
    const updateTasklist = useCallback(
        (messageId: string, update: (tasklist: Extract<MessageContent, {
            type: "tasklist"
    ...
    const renderThinkingTaskList = (tasklist: NonNullable<Extract<MessageContent, {
        type: "thinking"
    }>["tasklist"]>, messageId: string) => (
        <TaskList
    ...
    const renderDocumentCard = (content: Extract<MessageContent, { type: "document-card" }>) => (
        <DocumentCard {...content.card} className="w-[320px]" onClick={onShowCanvas}/>
    );
